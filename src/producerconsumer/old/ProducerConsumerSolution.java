...
class Producer implements Runnable {
    ...
    public Producer(final Vector<Integer> sharedQueue, final int size) {
...
class Consumer implements Runnable {
    ...
    public Consumer(final Vector<Integer> sharedQueue, final int size) {
        this.sharedQueue = sharedQueue;
        this.SIZE = size;
    }
